...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/cpeModel/cpeModel_Modal_CpeModel-es.json";
		break;
	case "en" :
		$source = "../json/cpeModel/cpeModel_Modal_CpeModel.json";
		break;
	case "pt_BR" :
		$source = "../json/cpeModel/cpeModel_Modal_CpeModel-pt_BR.json";
		break;
	default :
		$source = "../json/cpeModel/cpeModel_Modal_CpeModel.json";
		break;
...
<!-- Modal CpeModel -->
<div id="CpeModelsModalCpeModel" class="modalmask">
	<div class="modalbox movedown">
		<div class="modalBody">
			...
			<div class="modalTop">
				<!--
				<h2>
					<i class="{{cpeModelModalAddCpeModelIcon}}"></i>
					<span id="cpeModelTitle">{{cpeModelModalAddCpeModelTitle}}</span>
			...
			<form name="cpeModelModalCpeModel" method="POST" data-op="0" >
				<div class="modalHead"></div>
				<div class="modalMessageError"></div>
				<div class="modalMain">
					<input type="hidden" name="modalCpeModelInputHiddenIdCpeModel">
				...
				<div class="modalMessageRequired">{{cpeModelModalAddCpeModelMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="CpeModelsModalButtonAddCpeModel">
						{{cpeModelModalAddCpeModelButtonAdd}}
					</button>
					<button type="submit" name="CpeModelsModalButtonUpdateCpeModel" style="display:none;">
						{{cpeModelModalUpdateCpeModelButtonUpdate}}
					</button>
					<button type="button" name="CpeModelsModalButtonCleanCpeModel">
						{{cpeModelModalAddCpeModelButtonClean}}
					</button>
					<button type="button" name="CpeModelsModalButtonCloseModalCpeModel">
						{{cpeModelModalAddCpeModelButtonClose}}
					</button>
				</div>
			</form>
		</div>
