...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/planService/planService_Modal_PlanService-es.json";
		break;
	case "en" :
		$source = "../json/planService/planService_Modal_PlanService.json";
		break;
	case "pt_BR" :
		$source = "../json/planService/planService_Modal_PlanService-pt_BR.json";
		break;
	default :
		$source = "../json/planService/planService_Modal_PlanService.json";
		break;
...
<!-- Modal PlanService -->
<div id="PlanServicesModalPlanService" class="modalmask">
	<div class="modalbox movedown">
		<div class="modalBody">
			<div class="modalTop">
				<!--
				<h2>
					<i class="{{planServiceModalAddPlanServiceIcon}}"></i>
					<span id="planServiceTitle">{{planServiceModalAddPlanServiceTitle}}</span>
			...
			<form name="planServiceModalPlanService" method="POST" data-op="0" >
				...
				<div class="modalMain">
					<input type="hidden" name="modalPlanServiceInputHiddenIdPlanService">
				...
				<div class="modalMessageRequired">{{planServiceModalAddPlanServiceMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="PlanServicesModalButtonAddPlanService">
						{{planServiceModalAddPlanServiceButtonAdd}}
					</button>
					<button type="submit" name="PlanServicesModalButtonUpdatePlanService" style="display:none;">
						{{planServiceModalUpdatePlanServiceButtonUpdate}}
					</button>
					<button type="button" name="PlanServicesModalButtonCleanPlanService">
						{{planServiceModalAddPlanServiceButtonClean}}
					</button>
					<button type="button" name="PlanServicesModalButtonCloseModalPlanService">
						{{planServiceModalAddPlanServiceButtonClose}}
					</button>
				</div>
			</form>
		</div>
