...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/cpeType/cpeType_Modal_CpeType-es.json";
		break;
	case "en" :
		$source = "../json/cpeType/cpeType_Modal_CpeType.json";
		break;
	case "pt_BR" :
		$source = "../json/cpeType/cpeType_Modal_CpeType-pt_BR.json";
		break;
	default :
		$source = "../json/cpeType/cpeType_Modal_CpeType.json";
		break;		
...
<!-- Modal CpeType -->
<div id="CpeTypesModalCpeType" class="modalmask">
	<div class="modalbox movedown">
		<div class="modalBody">
			<div class="modalTop">
				<!--
				<h2>
					<i class="{{cpeTypeModalAddCpeTypeIcon}}"></i>
					<span id="cpeTypeTitle">{{cpeTypeModalAddCpeTypeTitle}}</span>
			...
			<form name="cpeTypeModalCpeType" method="POST" data-op="0" >
				<div class="modalHead"></div>
				<div class="modalMessageError"></div>
				<div class="modalMain">
					<input type="hidden" name="modalCpeTypeInputHiddenIdCpeType">
				...
				<div class="modalMessageRequired">{{cpeTypeModalAddCpeTypeMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="CpeTypesModalButtonAddCpeType">
						{{cpeTypeModalAddCpeTypeButtonAdd}}
					</button>
					<button type="submit" name="CpeTypesModalButtonUpdateCpeType" style="display:none;">
						{{cpeTypeModalUpdateCpeTypeButtonUpdate}}
					</button>
					<button type="button" name="CpeTypesModalButtonCleanCpeType">
						{{cpeTypeModalAddCpeTypeButtonClean}}
					</button>
					<button type="button" name="CpeTypesModalButtonCloseModalCpeType">
						{{cpeTypeModalAddCpeTypeButtonClose}}
					</button>
				</div>
			</form>
		</div>
