...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/group/group_Modal_Group-es.json";
		$textString="Letras";
		$textNumeric="Numérico";
		$textRut="Rut";		
		break;
	case "en" :
		$source = "../json/group/group_Modal_Group.json";
		$textString="String";
		$textNumeric="Numeric";
		$textRut="Rut";
		break;
	case "pt_BR" :
		$source = "../json/group/group_Modal_Group-pt_BR.json";
		$textString="String";
		$textNumeric="Numeric";
		$textRut="Rut";
		break;
			...
			$element[$x] = '<label data-element="' . $elementsHtml -> elements[$x] -> htmlFormElementType . '" data-required="' . $elementsHtml -> elements[$x] -> dataRequired . '" data-type="' . $elementsHtml -> elements[$x] -> dataTypeElementRequired . '" data-range="' . $elementsHtml -> elements[$x] -> dataRange . '" data-order="' . $elementsHtml -> elements[$x] -> dataOrder . '">' . $elementsHtml -> elements[$x] -> htmlLabel . '</label>
                <div class="input-control select">
                    <select name="' . $elementsHtml -> elements[$x] -> htmlFormElementName . '">
                        ...
                        <option value="String">'.$textString.'</option>
                        <option value="Numerico">'.$textNumeric.'</option>
                        <option value="Rut">'.$textRut.'</option>
                    </select>
                </div>';
			break;
		case 'checkbox' :
