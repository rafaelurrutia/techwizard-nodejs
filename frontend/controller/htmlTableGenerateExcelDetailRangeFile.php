...
try {
	...
	if (!isset($_POST["data"])) {
		...
		$generalListCertificateTitles = array("Detalle certificado correspondiente al id cliente ", "Speedtest cpe cableado", "Habitaciones registradas", "Certificados Wi-Fi correspondiente a ", "Prueba de descarga", "Prueba de ping", "Dispositivos en la red", "Prueba de speedtest", "Redes visibles", "Especificaciones extensores instalados");
		
		switch ($_POST["language"]) {
			case 'en' :
				$generalListCertificateTitles = array(
					"Detail certificate for the id client ", 
					"Speed test CPE wiring", 
					"Registered rooms", 
					"Corresponding certificates Wi-Fi ", 
					"Download test", 
					"Ping test", 
					"Sniffer", 
					"Speed test", 
			...
			case 'pt_BR' :
				$generalListCertificateTitles = array(
					...
					"Quartos registrados", 
					"Correspondente certificados Wi-Fi ",
					"Teste descarga", 
					"Teste ping", 
					"Sniffer", 
					"Teste speed test", 
...
function getTitles($index) {
	...
	$generalListCertificateTitles = array("Detalle certificado", "Speed test cpe cableado", "Habitaciones", "Certificados Wi-Fi a frecuencia 2.4 Ghz", "Certificados Wi-Fi a frecuencia 5 Ghz", "Especificaciones extensores instalados");
