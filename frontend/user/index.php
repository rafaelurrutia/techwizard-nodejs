...
<!--        <script src="../js/usertest/jquery/validationElementsForm.js"></script> -->
<!--        <script src="../js/usertest/jquery/keypressed.js"></script> -->
...
//				return true;
			...
			//			
			if(vacio(data.email)){
				showErrorMessage("input","modalUserInputEmailUser","Error email usuario, ","el texto es requerido.");
				return false;
			}else if(rango(data.email,"5-30")){
				showErrorMessage("input","modalUserInputEmailUser","Error email usuario, ","solo puedes ingresar letras, números y @ . - _ entre un rango de 5 a 30 caracteres.");
				return false;
			}else{
				cleanFormElements("input","modalUserInputEmailUser");
			}
			//
			if(vacio(data.phone)){
				showErrorMessage("input","modalUserInputPhoneUser","Error teléfono usuario, ","el texto es requerido.");
				return false;
			}else if(rango(data.phone,"3-20")){
				showErrorMessage("input","modalUserInputPhoneUser","Error teléfono usuario, ","solo puedes ingresar números entre un rango de 3 a 20 caracteres.");
				return false;
			}else{
				cleanFormElements("input","modalUserInputPhoneUser");
			}
			//
			*/
			return true;		
