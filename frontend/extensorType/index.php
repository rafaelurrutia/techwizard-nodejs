...
<html class="loading">
    ...
    <head>
       ...
       <!--    LIBRESRIAS LOCALES  -->      
        <script src="../js/extensorType/angular/app.js"></script>
        <script src="../lib/metro/js/metro-dropdown.js"></script>
        <script src="../js/extensorType/jquery/modalResize.js"></script>
<!--        <script src="../js/extensorTypetest/jquery/validationElementsForm.js"></script> -->
<!--        <script src="../js/extensorTypetest/jquery/keypressed.js"></script> -->
		<script src="../js/extensorType/jquery/keypress.js"></script>
...
<!--        <script src="../js/default/detectBrowser.js"></script> -->
        <script src="../js/extensorType/jquery/tableExtensorType.js"></script>
        ...
        <script type="text/javascript" language="JavaScript">
            ...
            $(function( ) {
            	...
            	if(getAccess("add")==0 && location!=""){
        			$("#ExtensorTypesModalExtensorType").hide(); 	
        	 	}		
/*
...
*/
		...
		var validate = function(option) {
			...
			var data = {
				"name" 		: $("input[name='modalExtensorTypeInputNameExtensorType']").val().trim(),
			};
			
			if(vacio(data.name)){
				showErrorMessage("input","modalExtensorTypeInputNameExtensorType",textErrorValidateTitle1,textErrorValidateSubTitle1_1);
				return false;
			}else if(rango(data.name,"3-30")){
				showErrorMessage("input","modalExtensorTypeInputNameExtensorType",textErrorValidateTitle1,textErrorValidateSubTitle2_1);
				return false;
			}else if(uniqueName(data.name,option)){
				showErrorMessage("input","modalExtensorTypeInputNameExtensorType",textErrorValidateTitle1,textErrorValidateSubTitle3_1);
				return false;
			}else{
				cleanFormElements("input","modalExtensorTypeInputNameExtensorType");
			}
...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <div id="main">
            ...
            <?php include'extensorType.php'; ?>            
            <?php 
            
            if($permiso1[2]==0 && $permiso1[3]==0){
				
			}else{
				include'extensorType_Modal_ExtensorType.php'; 
			}
