...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/extensorType/extensorType_Modal_ExtensorType-es.json";
		break;
	case "en" :
		$source = "../json/extensorType/extensorType_Modal_ExtensorType.json";
		break;
	case "pt_BR" :
		$source = "../json/extensorType/extensorType_Modal_ExtensorType-pt_BR.json";
		break;
	default :
		$source = "../json/extensorType/extensorType_Modal_ExtensorType.json";
		break;
...
<!-- Modal ExtensorType -->
<div id="ExtensorTypesModalExtensorType" class="modalmask">
	<div class="modalbox movedown">
		<div class="modalBody">
			<div class="modalTop">
				<div style="line-height: 35px;">
					<strong>
						<i class="{{extensorTypeModalAddExtensorTypeIcon}}"></i>
						<span id="extensorTypeTitle">{{extensorTypeModalAddExtensorTypeTitle}}</span>					
					</strong>
				</div>	
			</div>
			
			<form name="extensorTypeModalExtensorType" method="POST" data-op="0" >
				<div class="modalHead"></div>
				<div class="modalMessageError"></div>
				<div class="modalMain">
					<input type="hidden" name="modalExtensorTypeInputHiddenIdExtensorType">
				...
				<div class="modalMessageRequired">{{extensorTypeModalAddExtensorTypeMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="ExtensorTypesModalButtonAddExtensorType">
						{{extensorTypeModalAddExtensorTypeButtonAdd}}
					</button>
					<button type="submit" name="ExtensorTypesModalButtonUpdateExtensorType" style="display:none;">
						{{extensorTypeModalUpdateExtensorTypeButtonUpdate}}
					</button>
					<button type="button" name="ExtensorTypesModalButtonCleanExtensorType">
						{{extensorTypeModalAddExtensorTypeButtonClean}}
					</button>
					<button type="button" name="ExtensorTypesModalButtonCloseModalExtensorType">
						{{extensorTypeModalAddExtensorTypeButtonClose}}
					</button>
				</div>
			</form>
		</div>
