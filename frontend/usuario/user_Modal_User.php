...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/user/user_Modal_User-es.json";
		break;
	case "en" :
		$source = "../json/user/user_Modal_User.json";
		break;
	case "pt_BR" :
		$source = "../json/user/user_Modal_User-pt_BR.json";
		break;
	default :
		$source = "../json/user/user_Modal_User.json";
		break;
...
<!-- Modal User -->
<div id="UsersModalUser" class="modalmask">
		...
		<div class="modalBody">
			<div class="modalTop">
				...
				<div style="line-height: 35px;">
					<strong>
						<i class="{{userModalAddUserIcon}}"></i>
						<span id="userTitle">{{userModalAddUserTitle}}</span>
					</strong>
				</div>
				
			</div>
			<form name="userModalUser" method="POST" data-op="0" >
				<div class="modalHead"></div>
				<div class="modalMessageError"></div>
				<div class="modalMain">
					<input type="hidden" name="modalUserInputHiddenIdUser">
				...
				<div class="modalMessageRequired">{{userModalAddUserMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="UsersModalButtonAddUser">
						{{userModalAddUserButtonAdd}}
					</button>
					<button type="submit" name="UsersModalButtonUpdateUser" style="display:none;">
						{{userModalUpdateUserButtonUpdate}}
					</button>
					<button type="button" name="UsersModalButtonCleanUser">
						{{userModalAddUserButtonClean}}
					</button>
					<button type="button" name="UsersModalButtonCloseModalUser">
						{{userModalAddUserButtonClose}}
					</button>
				</div>
			</form>
		</div>
