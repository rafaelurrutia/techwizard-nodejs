...
<html class="loading">
    ...
    <head>
       ...
       <!--    LIBRESRIAS LOCALES  -->      
        <script src="../js/room/angular/app.js"></script>
        <script src="../lib/metro/js/metro-dropdown.js"></script>
        <script src="../js/room/jquery/modalResize.js"></script>
<!--        <script src="../js/roomtest/jquery/validationElementsForm.js"></script> -->
<!--        <script src="../js/roomtest/jquery/keypressed.js"></script> -->
		<script src="../js/room/jquery/keypress.js"></script>
...
<!--        <script src="../js/default/detectBrowser.js"></script> -->
        <script src="../js/room/jquery/tableRoom.js"></script>
...
*/
		...
		var validate = function(option) {
			...
			var data = {
				"name" 		: $("input[name='modalRoomInputNameRoom']").val().trim(),
			};
			
			if(vacio(data.name)){
				showErrorMessage("input","modalRoomInputNameRoom",textErrorValidateTitle1,textErrorValidateSubTitle1_1);
				return false;
			}else if(rango(data.name,"3-30")){
				showErrorMessage("input","modalRoomInputNameRoom",textErrorValidateTitle1,textErrorValidateSubTitle2_1);
				return false;
			}else if(uniqueName(data.name,option)){
				showErrorMessage("input","modalRoomInputNameRoom",textErrorValidateTitle1,textErrorValidateSubTitle3_1);
				return false;
			}else{
				cleanFormElements("input","modalRoomInputNameRoom");
			}
