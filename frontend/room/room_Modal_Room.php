...
switch ($_SESSION['lang']) {
	case "es" :
		$source = "../json/room/room_Modal_Room-es.json";
		break;
	case "en" :
		$source = "../json/room/room_Modal_Room.json";
		break;
	case "pt_BR" :
		$source = "../json/room/room_Modal_Room-pt_BR.json";
		break;
	default :
		$source = "../json/room/room_Modal_Room.json";
		break;
...
<!-- Modal Room -->
<div id="RoomsModalRoom" class="modalmask">
	<div class="modalbox movedown">
		<div class="modalBody">
			<div class="modalTop">
				<!--
				<h2>
					<i class="{{roomModalAddRoomIcon}}"></i>
					<span id="roomTitle">{{roomModalAddRoomTitle}}</span>
			...
			<form name="roomModalRoom" method="POST" data-op="0" >
				<div class="modalHead"></div>
				<div class="modalMessageError"></div>
				<div class="modalMain">
					<input type="hidden" name="modalRoomInputHiddenIdRoom">
				...
				<div class="modalMessageRequired">{{roomModalAddRoomMessageRequired}}</div>
				<div class="modalFoot">
					<button type="submit" name="RoomsModalButtonAddRoom">
						{{roomModalAddRoomButtonAdd}}
					</button>
					<button type="submit" name="RoomsModalButtonUpdateRoom" style="display:none;">
						{{roomModalUpdateRoomButtonUpdate}}
					</button>
					<button type="button" name="RoomsModalButtonCleanRoom">
						{{roomModalAddRoomButtonClean}}
					</button>
					<button type="button" name="RoomsModalButtonCloseModalRoom">
						{{roomModalAddRoomButtonClose}}
					</button>
				</div>
			</form>
		</div>
